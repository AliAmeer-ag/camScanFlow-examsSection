<template>
  <div class="flex flex-col gap-6">
    ...
    <div class="flex align-center gap-8">
      <button @click="handleAgree" class="">Agree</button>
      <button @click="handleDisagree" class="secondary">Disagree</button>
    </div>
  </div>
</template>
